...
struct StartMode : Mode {
  ...
  Section texts[17] = { 
	  ...
	  {"But everyone I saw, old, young, it didn't matter, they just... smiled and pointed, like some silent guide. No words, just a finger pointing down the road.", "IMG_3082.png"},
	  {"I even bought this cross for a bit of protection. Call me superstitious, but something feels... off.", "IMG_3084.png"},
	  {"I'm recording this now. I have no idea what's waiting for me. But if you're hearing this, and I didn't make it back, don't come looking for me. ", "pure_black.png"},
