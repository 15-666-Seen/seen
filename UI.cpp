...
void GameplayUI::setInteractionText(const std::string &text) {
  ...
  interaction.set_text("Press [F] to ");
}
...
void GameplayUI::DrawUI(glm::uvec2 const &drawable_size) {
  ...
  interaction.draw(100.f, drawable_size, width, glm::vec2(x, y), 2.f, glm::vec3(0.0f, 0.2f, 0.0f));

  x = drawable_size.x * 0.f;
  y = drawable_size.y * 1.0f;
  //width = drawable_size.x * 0.75f;
  //mission.set_bound(drawable_size.x * 0.9f);
  mission.draw(100.f, drawable_size, width, glm::vec2(x, y), 2.f, glm::vec3(0.0f, 0.2f, 0.0f));
  ...
  //                glm::u8vec4(0xFF, 0xFF, 0xFF, 0x00));
    ...
    dialogue.draw(100.f, drawable_size, width, glm::vec2(x, y), 4.f, glm::vec3(0.0f, 0.2f, 0.0f));
